...
export default function About() {
  return (
    <section id="apropos" className="bg-cream py-20 sm:py-28">
      <div className="mx-auto max-w-5xl px-6">
        <Reveal className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="text-navy/80 leading-relaxed">
            ...
            leurs besoins de restauration quotidienne. Grâce à une équipe de
            plus de 30 collaborateurs et à une centrale de production moderne,
            nous préparons chaque jour des repas savoureux, équilibrés et
            conformes aux plus hauts standards de qualité et d&apos;hygiène.
          </p>
          <p className="text-navy/80 leading-relaxed mt-4">
            Notre mission est de fournir des solutions de restauration
            fiables, adaptées aux besoins de nos clients et capables
            d&apos;accompagner leur croissance.
          </p>
        </Reveal>

        <Reveal delay={0.1} className="grid grid-cols-3 gap-4 sm:gap-8 max-w-2xl mx-auto mb-16">
          {stats.map((s) => (
